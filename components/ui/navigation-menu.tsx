...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md bg-white px-4 py-2 transition-colors focus:bg-slate-100 focus:text-slate-900 focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-[#6215dd51] data-[active]:text-white data-[state=open]:text-white data-[state=open]:bg-[#6215dd51] hover:bg-[#6215dd51] hover:text-white bg-transparent text-black",
);
